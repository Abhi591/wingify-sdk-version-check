...
const gt = __nccwpck_require__(8980)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const scanner_1 = __importDefault(__nccwpck_require__(8725));
const node_1 = __importDefault(__nccwpck_require__(2081));
const java_1 = __importDefault(__nccwpck_require__(3189));
const php_1 = __importDefault(__nccwpck_require__(6505));
...
async function fetchLatest(lang) {
    try {
        // Node (npm)
        if (lang === "node") {
            const res = await axios_1.default.get("https://registry.npmjs.org/vwo-fme-pod-sdk/latest");
            return res.data.version;
        }
        // Ruby (RubyGems)
        if (lang === "ruby") {
            const res = await axios_1.default.get("https://rubygems.org/api/v1/gems/vwo-pod-ruby-sdk.json");
            return res.data.version;
        }
        // PHP (Packagist)
        if (lang === "php") {
            const res = await axios_1.default.get("https://repo.packagist.org/p2/vwo/vwo-fme-ddd-sdk.json");
        ...
        // Java (Maven Central)
        if (lang === "java") {
            const res = await axios_1.default.get("https://repo1.maven.org/maven2/com/vwo/sdk/vwo-fme-dd-sdk/maven-metadata.xml", { responseType: "text" });
        ...
        // Go (Go module proxy)
        if (lang === "go") {
            const res = await axios_1.default.get("https://proxy.golang.org/github.com/wingify/vwo-dd-go-sdk/@latest", { timeout: 10000 });
            return res.data.Version || null;
        }
        // .NET (NuGet)
        if (lang === "dotnet") {
            const res = await axios_1.default.get("https://api.nuget.org/v3-flatcontainer/vwo.dd.sdk/index.json");
...
async function notifySlack(message) {
    const botToken = process.env.SLACK_NOTIFICATIONS_BOT_TOKEN || process.env.SLACK_BOT_TOKEN;
